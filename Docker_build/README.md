...
`docker build --tag ghcr.io/tuva-health/dbt_all:v1.10.6  --target dbt-all .`

export CR_PAT=ghp_xxxx
echo $CR_PAT | docker login ghcr.io -u tuva-health --password-stdin

`docker push ghcr.io/tuva-health/dbt_all:v1.10.6`
